...
import test.jiyun.com.shiguangdemo.utils.PixelUtil;

/**
 * 项目名称:时光网
 * 类描述:  自定义view 仿通讯录；
 * 创建人:LENOVO
 * 创建时间:2017-6-30 11:54
 * 修改人:
 * 修改内容:
 */
...
public class MyLetterView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //单个字母的高度；
        int singleHeight = heigth / letters.length;
        ...
        for (int i = 0; i < letters.length; i++) {
            ...
            // 首先确定每个字母的横坐标的位置，横坐标：自定义view的一半 - （减去）单个字母的宽度的一半
            float xPos = width / 2 - paint.measureText(letters[i]) / 2;
            int yPos = singleHeight * (i + 1);
